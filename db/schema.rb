...
ActiveRecord::Schema[7.0].define(version: 2025_01_09_064533) do
  ...
  create_table "active_list_allergy", primary_key: "active_list_id", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "active_list_problem", primary_key: "active_list_id", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "status", limit: 50
    t.float "sort_weight", limit: 53
  end

  create_table "active_list_type", primary_key: "active_list_type_id", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "cohort", primary_key: "cohort_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "cohort_member", primary_key: ["cohort_id", "patient_id"], charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "complex_obs", primary_key: "obs_id", id: :integer, default: 0, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept", primary_key: "concept_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "retired", limit: 2, default: 0, null: false
    t.string "short_name"
    t.text "description"
    t.text "form_text"
  ...
  create_table "concept_answer", primary_key: "concept_answer_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_class", primary_key: "concept_class_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_complex", primary_key: "concept_id", id: :integer, default: nil, charset: "latin1", force: :cascade do |t|
    t.string "handler"
  end

  create_table "concept_datatype", primary_key: "concept_datatype_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
  ...
  create_table "concept_derived", primary_key: "concept_id", id: :integer, default: 0, charset: "utf8mb3", force: :cascade do |t|
    t.text "rule", size: :medium
    t.datetime "compile_date", precision: nil
    t.string "compile_status"
    t.string "class_name", limit: 1024
  end

  create_table "concept_description", primary_key: "concept_description_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "concept_map", primary_key: "concept_map_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "source"
  ...
  create_table "concept_name", primary_key: "concept_name_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_name_tag", primary_key: "concept_name_tag_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_name_tag_map", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_numeric", primary_key: "concept_id", id: :integer, default: 0, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_proposal", primary_key: "concept_proposal_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id"
  ...
  create_table "concept_proposal_tag_map", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_set", primary_key: "concept_set_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "concept_set_derived", primary_key: ["concept_id", "concept_set"], charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
    t.integer "concept_set", default: 0, null: false
    t.float "sort_weight", limit: 53
  end

  create_table "concept_source", primary_key: "concept_source_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_state_conversion", primary_key: "concept_state_conversion_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "concept_synonym", primary_key: ["synonym", "concept_id"], charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "concept_word", primary_key: "concept_word_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "district", primary_key: "district_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, default: "1900-01-01 00:00:00", null: false
  ...
  create_table "drug", primary_key: "drug_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "drug_ingredient", primary_key: ["ingredient_id", "concept_id"], charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "drug_order", primary_key: "order_id", id: :integer, default: 0, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "encounter", primary_key: "encounter_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "encounter_type", null: false
    t.integer "patient_id", default: 0, null: false
    t.integer "provider_id", default: 0, null: false
    t.integer "location_id"
    t.integer "form_id"
    t.datetime "encounter_datetime", precision: nil, default: "1900-01-01 00:00:00", null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, default: "1900-01-01 00:00:00", null: false
    t.integer "voided", limit: 2, default: 0, null: false
    t.integer "voided_by"
  ...
  create_table "encounter_type", primary_key: "encounter_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 50, default: "", null: false
    t.text "description"
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, null: false
  ...
  create_table "external_source", primary_key: "external_source_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "field", primary_key: "field_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
    t.text "description"
  ...
  create_table "field_answer", primary_key: ["field_id", "answer_id"], charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "field_type", primary_key: "field_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 50
  ...
  create_table "form", primary_key: "form_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
  ...
  create_table "form2program_map", primary_key: ["program", "encounter_type"], charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "form_field", primary_key: "form_field_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "formentry_archive", primary_key: "formentry_archive_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "formentry_error", primary_key: "formentry_error_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.text "form_data", size: :medium, null: false
  ...
  create_table "formentry_queue", primary_key: "formentry_queue_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.text "form_data", size: :medium, null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, default: "1900-01-01 00:00:00", null: false
  end

  create_table "formentry_xsn", primary_key: "formentry_xsn_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "hl7_in_archive", primary_key: "hl7_in_archive_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "hl7_in_error", primary_key: "hl7_in_error_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "hl7_source", default: 0, null: false
  ...
  create_table "hl7_in_queue", primary_key: "hl7_in_queue_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "hl7_source", default: 0, null: false
    t.text "hl7_source_key"
    t.text "hl7_data", size: :medium, null: false
  ...
  create_table "hl7_source", primary_key: "hl7_source_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
  ...
  create_table "htmlformentry_html_form", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "form_id"
  ...
  create_table "liquibasechangeloglock", primary_key: "ID", id: :integer, default: nil, charset: "latin1", force: :cascade do |t|
    t.boolean "LOCKED", null: false
    t.datetime "LOCKGRANTED", precision: nil
    t.string "LOCKEDBY"
  end

  create_table "location", primary_key: "location_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
    t.string "description"
  ...
  create_table "location_tag_map", primary_key: ["location_id", "location_tag_id"], charset: "latin1", force: :cascade do |t|
  ...
  create_table "logic_rule_definition", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "uuid", limit: 38, null: false
    t.string "name", null: false
    t.string "description", limit: 1000
  ...
  create_table "logic_rule_token", primary_key: "logic_rule_token_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "creator", null: false
  ...
  create_table "logic_rule_token_tag", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "logic_rule_token_id", null: false
    t.string "tag", limit: 512, null: false
    t.index ["logic_rule_token_id"], name: "token_tag"
  end

  create_table "logic_token_registration", primary_key: "token_registration_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "creator", null: false
    t.datetime "date_created", precision: nil, default: "0002-11-30 00:00:00", null: false
    t.integer "changed_by"
    t.datetime "date_changed", precision: nil
  ...
  create_table "logic_token_registration_tag", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "mime_type", primary_key: "mime_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "mime_type", limit: 75, default: "", null: false
    t.text "description"
    t.index ["mime_type_id"], name: "mime_type_id"
  end

  create_table "moh_other_medications", primary_key: "medication_id", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "drug_inventory_id", null: false
  ...
  create_table "moh_regimen_doses", primary_key: "dose_id", id: :integer, charset: "latin1", force: :cascade do |t|
    t.float "am"
    t.float "pm"
    t.datetime "date_created", precision: nil
    t.datetime "date_updated", precision: nil
  ...
  create_table "moh_regimen_ingredient", primary_key: "ingredient_id", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "moh_regimen_ingredient_starter_packs", primary_key: "ingredient_id", id: :integer, charset: "latin1", force: :cascade do |t|
    t.integer "regimen_id"
    t.integer "drug_inventory_id"
    t.integer "dose_id"
    t.float "min_weight"
  ...
  create_table "moh_regimen_ingredient_tb_treatment", id: false, charset: "latin1", force: :cascade do |t|
    t.integer "ingredient_id", default: 0, null: false
    t.integer "regimen_id"
    t.integer "drug_inventory_id"
    t.integer "dose_id"
  ...
  create_table "moh_regimen_lookup", primary_key: "regimen_lookup_id", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "national_id", id: :integer, charset: "latin1", options: "ENGINE=MyISAM", force: :cascade do |t|
  ...
  create_table "note", primary_key: "note_id", id: :integer, default: 0, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "notification_alert_recipient", primary_key: ["alert_id", "user_id"], charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "notification_template", primary_key: "template_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 50
    t.text "template"
  ...
  create_table "notification_tracker", primary_key: "tracker_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "notification_datetime", precision: nil, null: false
    t.integer "patient_id", null: false
    t.integer "user_id", null: false
  end
  ...
  create_table "ntp_regimens", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "drug_id"
    t.float "am_dose"
  ...
  create_table "obs", primary_key: "obs_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "person_id", null: false
    t.integer "concept_id", default: 0, null: false
    t.integer "encounter_id"
    t.integer "order_id"
    t.datetime "obs_datetime", precision: nil, default: "1900-01-01 00:00:00", null: false
    t.integer "location_id"
  ...
  create_table "order_extension", primary_key: "order_extension_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "order_id", null: false
  ...
  create_table "order_type", primary_key: "order_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
    t.string "description", default: "", null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, null: false
  ...
  create_table "orders", primary_key: "order_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "discontinued_date", precision: nil
  ...
  create_table "patient", primary_key: "patient_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "tribe"
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, default: "1900-01-01 00:00:00", null: false
    t.integer "changed_by"
  ...
  create_table "patient_identifier_type", primary_key: "patient_identifier_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 50, default: "", null: false
    t.text "description", null: false
  ...
  create_table "patient_program", primary_key: "patient_program_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "patient_id", default: 0, null: false
  ...
  create_table "patient_state", primary_key: "patient_state_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "patientflags_flag", primary_key: "flag_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "patientflags_flag_tag", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "patientflags_tag", primary_key: "tag_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "patients_for_location", primary_key: "patient_id", id: :integer, default: nil, charset: "utf8mb3", options: "ENGINE=MyISAM", force: :cascade do |t|
  end

  create_table "patients_to_merge", id: false, charset: "utf8mb3", options: "ENGINE=MyISAM", force: :cascade do |t|
    t.integer "patient_id"
    t.integer "to_merge_to_id"
  end

  create_table "person", primary_key: "person_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "person_address", primary_key: "person_address_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "person_id"
    t.integer "preferred", limit: 2, default: 0, null: false
    t.string "address1", limit: 50
    t.string "address2", limit: 50
  ...
  create_table "person_attribute", primary_key: "person_attribute_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "person_attribute_type", primary_key: "person_attribute_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", limit: 50, default: "", null: false
    t.text "description", null: false
    t.string "format", limit: 50
  ...
  create_table "person_name", primary_key: "person_name_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "preferred", limit: 2, default: 0, null: false
    t.integer "person_id"
  ...
  create_table "person_name_code", primary_key: "person_name_code_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "pharmacy_batch_items", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "date_changed", precision: nil, default: -> { "CURRENT_TIMESTAMP" }
    t.boolean "voided"
    t.integer "voided_by"
    t.string "void_reason"
    t.datetime "date_voided", precision: nil
  ...
  create_table "pharmacy_obs", primary_key: "pharmacy_module_id", id: :integer, charset: "latin1", force: :cascade do |t|
  ...
  create_table "program", primary_key: "program_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, null: false
    t.integer "changed_by"
  ...
  create_table "program_encounter", primary_key: "program_encounter_id", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "patient_id"
    t.datetime "date_time", precision: nil
    t.integer "program_id"
  end

  create_table "program_encounter_details", id: :integer, charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
    t.integer "encounter_id"
  ...
  create_table "program_encounter_type_map", primary_key: "program_encounter_type_map_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id"
  ...
  create_table "program_location_restriction", primary_key: "program_location_restriction_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id"
    t.integer "location_id"
  ...
  create_table "program_orders_map", primary_key: "program_orders_map_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id"
    t.integer "concept_id"
  ...
  create_table "program_patient_identifier_type_map", primary_key: "program_patient_identifier_type_map_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id"
  ...
  create_table "program_relationship_type_map", primary_key: "program_relationship_type_map_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id"
  ...
  create_table "program_workflow", primary_key: "program_workflow_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "program_id", default: 0, null: false
    t.integer "concept_id", default: 0, null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, null: false
  ...
  create_table "program_workflow_state", primary_key: "program_workflow_state_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "regimen", primary_key: "regimen_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "concept_id", default: 0, null: false
  ...
  create_table "regimen_drug_order", primary_key: "regimen_drug_order_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "region", primary_key: "region_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
    t.integer "creator", default: 0, null: false
    t.datetime "date_created", precision: nil, default: "1900-01-01 00:00:00", null: false
    t.boolean "retired", default: false, null: false
  ...
  create_table "relationship", primary_key: "relationship_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "relationship_type", primary_key: "relationship_type_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "report_def", primary_key: "report_def_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "report_object", primary_key: "report_object_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
    t.string "description", limit: 1000
  ...
  create_table "report_schema_xml", primary_key: "report_schema_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
    t.text "description", null: false
    t.text "xml_data", size: :medium, null: false
    t.string "uuid", limit: 38, null: false
  ...
  create_table "reporting_report_design", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "uuid", limit: 38, null: false
    t.string "name", null: false
    t.string "description", limit: 1000
  ...
  create_table "reporting_report_design_resource", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "uuid", limit: 38, null: false
    t.string "name", null: false
    t.string "description", limit: 1000
  ...
  create_table "role", primary_key: "role", id: { type: :string, limit: 50, default: "" }, charset: "utf8mb3", force: :cascade do |t|
    t.string "description", default: "", null: false
    t.string "uuid", limit: 38, null: false
    t.index ["uuid"], name: "role_uuid_index", unique: true
  end

  create_table "role_privilege", primary_key: ["privilege", "role"], charset: "utf8mb3", force: :cascade do |t|
    t.string "role", limit: 50, default: "", null: false
    t.string "privilege", limit: 50, default: "", null: false
    t.index ["role"], name: "role_privilege"
  end

  create_table "role_role", primary_key: ["parent_role", "child_role"], charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "scheduler_task_config", primary_key: "task_config_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "scheduler_task_config_property", primary_key: "task_config_property_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", null: false
    t.text "value"
  ...
  create_table "schema_info", id: false, charset: "latin1", options: "ENGINE=MyISAM", force: :cascade do |t|
    t.integer "version"
  end
  ...
  create_table "serialized_object", primary_key: "serialized_object_id", id: :integer, charset: "latin1", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "task", primary_key: "task_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "url"
    ...
    t.datetime "has_obs_value_datetime", precision: nil
  ...
  create_table "traditional_authority", primary_key: "traditional_authority_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
  ...
  create_table "tribe", primary_key: "tribe_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.boolean "retired", default: false, null: false
    t.string "name", limit: 50, default: "", null: false
  end
  ...
  create_table "users", primary_key: "user_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.datetime "token_expiry_time", precision: nil
  ...
  create_table "village", primary_key: "village_id", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name", default: "", null: false
  ...
  create_table "weight_for_height", id: false, charset: "latin1", options: "ENGINE=MyISAM", force: :cascade do |t|
  ...
  create_table "weight_for_heights", id: :integer, charset: "latin1", force: :cascade do |t|
    t.float "supine_cm"
  ...
  create_table "weight_height_for_age", id: false, charset: "latin1", options: "ENGINE=MyISAM", force: :cascade do |t|
  ...
  create_table "weight_height_for_ages", id: false, charset: "latin1", options: "ENGINE=MyISAM", force: :cascade do |t|
